...
def CreateDataSet(data_folder, data_file_number, v1, v2, v3, target, I1, I2, I3):
    ...
    text_string = data_folder + "/real-" + str(data_file_number) + ": v1=" + v1 + ", v2=" + v2 + ", v3=" + v3 + ", v4=" + target + " (target), I_1=" + I1 + ", I_2=" + I2 + ", I_3=" + I3 + "\n" 
...
for i in range(1,n+1):
    ...
    CreateDataSet(data_folder, i, v1, v2, v3, target, I1, I2, I3)
